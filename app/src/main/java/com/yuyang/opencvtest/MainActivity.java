...
public class MainActivity extends Activity implements CvCameraViewListener2{
    ...
    private BaseLoaderCallback  mLoaderCallback = new BaseLoaderCallback(this) {
        ...
        public void onManagerConnected(int status) {
			Log.i("Main", "Start Loader Callback");
            switch (status) {
			...
			Log.i("Main", "Ende Loader Callback");
        }
    };
    ...
    private Handler handler = new Handler()
	{
		...
		{
			Log.i("Main", "Start Handle Message");
			switch(msg.what) {
			...
			Log.i("Main", "Ende Handle Message");
		}
	};

	@Override
	protected void onResume() {
		Log.i("Main", "Start On Resume");
		super.onResume();

		Log.i("Main", "Call OpenCVLoader");
		OpenCVLoader.initAsync(OpenCVLoader.OPENCV_VERSION_2_4_8, this, mLoaderCallback);
		Log.i("Main", "Ende On Resume");
	}
